...
import { MetaCategoriesPage } from "./page/meta_categories";
import { MetaCategoryPage } from "./page/meta_category";
import { MetaTagPage } from "./page/meta_tag.tsx";
import { MetaTagsPage } from "./page/meta_tags.tsx";
                ...
                <ProfileContext.Provider value={profile}>
                    ...
                    <Switch>
                        ...
                        <RouteMe path="/tags/:name">
                            {params => {
                                return <MetaTagPage name={params.name || ""} />;
                            }}
                        </RouteMe>

                        <RouteMe path="/categories">
                            <MetaCategoriesPage />
                        </RouteMe>

                        <RouteMe path="/categories/:name">
                            {params => {
                                return <MetaCategoryPage name={params.name || ""} />;
                            }}
                        </RouteMe>
...
function RouteMe(
    { path, children, headerComponent, paddingClassName }: {
        path: PathPattern;
