        ...
        <Waiting for={feed || error}>
            {feed && (
                <Helmet>
                    ...
                    <meta
                        name="keywords"
                        content={feed.tags.map(({ name }) => name).join(", ")}
                    />
                    <meta
                        name="description"
                        content={feed.content.length > 200
                                        ...
                                        {profile?.permission && (
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    onClick={topFeed}
                                                    className={`flex-1 flex flex-col items-end justify-center px-2 py rounded-full transition ${
                                                        top > 0
                                ...
                                <div className="mt-6 flex flex-col gap-2">
                                    {feed.tags.length > 0 && (
                                        <div className="flex flex-row flex-wrap gap-x-2">
                                            {feed.tags.map(({ name }, index) => <HashTag key={index} name={name} />)}
                                        </div>
                                    )}
                                </div>
                            </article>
