...
export function TimelinePage() {
    const [feeds, setFeeds] = useState<
        Partial<Record<number, { id: number; alias?: string | null; title: string | null; createdAt: Date }[]>>
    >();
...
export function FeedItem(
    { id, alias, title, createdAt }: { id: string; alias?: string | null; title: string; createdAt: Date },
) {
