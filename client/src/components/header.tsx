            ...
            {when
                && (
                    <Link
                        ...
                        className={`${
                            menu ? "" : "hidden"
                        } md:block cursor-pointer hover:text-theme duration-300 px-2 py-4 md:p-4 text-sm ${
    ...
    return (
        <>
            <NavItem
                ...
                onClick={onClick}
                title={t("home")}
                selected={location === "/" || location.startsWith("/posts")}
                href="/"
            />
            <NavItem
                menu={menu}
            ...
            <NavItem
                ...
                href="/categories"
            />
            <NavItem menu={menu} onClick={onClick} title={t("tags")} selected={location === "/tags"} href="/tags" />
            <NavItem
                menu={menu}
                onClick={onClick}
